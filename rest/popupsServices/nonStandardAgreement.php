...
function popupsServicesNonStandardAgreementFetchDeal($dealId)
{
...
// --- ძირითადი ლოგიკა ---
$deal = popupsServicesNonStandardAgreementFetchDeal($dealId);
if (!$deal) {
...
if($dealId){
    ...
    $wfId = CBPDocument::StartWorkflow(
        104, // Workflow ID - adjust if you have a different workflow for agreement check
