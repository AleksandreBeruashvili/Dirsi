        ...
        <div class="content-grid">
            <div class="property-info">
                <div class="info-container-bg" style="<?php echo (isset($backgroundfoto) && $backgroundfoto) ? 'background-image: url(\'' . $backgroundfoto . '\'); background-size: 100%; margin-top: -25px; width: 100%; background-repeat: no-repeat; height: 35%;' : ''; ?>">
                    ...
                    <div class="info-table">
                        ...
                        <div class="info-table-text">
                            ...
                            <div class="info-row" id="enddateDiv">
                                <span class="info-label">CONSTRUCTION COMPLETION DATE:</span>
                    ...
                    <div class="gayidvebismenejeri">SALES MANAGER</div>
                    ...
                    <div class="info-container-bg" style="<?php echo (isset($greenfoto) && $greenfoto) ? 'background-image: url(\'' . $greenfoto . '\'); background-size: 100%; width: 100%; background-repeat: no-repeat; margin-left: -20px; height: 90px;' : ''; ?>">
                        <div class="footer2 offer-banner-head">
                            <span class="offer-banner-date">OFFER DATE: <?php echo $date; ?></span>
                            <?php if ($seb_currency > 0): ?><span class="offer-banner-nbg">NBG rate (USD→GEL): <?php echo number_format($seb_currency, 4, '.', ''); ?></span><?php endif; ?>
                        </div>
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 70px; vertical-align: top;">
                                    <table style="border-collapse: collapse; margin-bottom: 10px;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                            TOTAL PRICE (USD): $<?php echo $totalprice; ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="border-collapse: collapse;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                            PRICE PER m2 (USD): $<?php echo $kvmprice; ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="vertical-align: top;">
                                    <table style="border-collapse: collapse; margin-bottom: 10px;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                            TOTAL PRICE (GEL): ₾<?php echo $totalpriceGEL !== null ? number_format($totalpriceGEL, 2, '.', '') : '—'; ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="border-collapse: collapse;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                            PRICE PER m2 (GEL): ₾<?php echo $kvmpriceGEL !== null ? number_format($kvmpriceGEL, 2, '.', '') : '—'; ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
