                ...
                <div class="info-container-bg" style="<?php echo (isset($backgroundfoto) && $backgroundfoto) ? 'background-image: url(\'' . $backgroundfoto . '\'); background-size: 100%; margin-top: -25px; width: 100%; background-repeat: no-repeat; height: 35%;' : ''; ?>">
                    ...
                    <div class="info-container-bg" style="<?php echo (isset($greenfoto) && $greenfoto) ? 'background-image: url(\'' . $greenfoto . '\'); background-size: 100%; width: 100%; background-repeat: no-repeat; margin-left: -20px; height: 90px;' : ''; ?>">
                        <div class="footer2 offer-banner-head">
                            <span class="offer-banner-date">ᲨᲔᲗᲐᲕᲐᲖᲔᲑᲘᲡ ᲗᲐᲠᲘᲦᲘ: <?php echo $date; ?></span>
                            <?php if ($seb_currency > 0): ?><span class="offer-banner-nbg">NBG კურსი (USD→GEL): <?php echo number_format($seb_currency, 4, '.', ''); ?></span><?php endif; ?>
                        </div>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top;">
                                    <table style="border-collapse: collapse; margin-bottom: 10px;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                                ჯამური ღირებულება (GEL): ₾<?php echo $totalpriceGEL !== null ? number_format($totalpriceGEL, 2, '.', '') : '—'; ?>
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="border-collapse: collapse;">
                                        <tr>
                                            <td style="vertical-align: middle;">
                                                ღირებულება მ2 (GEL): ₾<?php echo $kvmpriceGEL !== null ? number_format($kvmpriceGEL, 2, '.', '') : '—'; ?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
