...
// $contactInfo = array();
// if ($urlArr[4] == "deal") {
//     if (is_numeric($urlArr[6]) && $urlArr[6] != 0) {
//         $dealId = $urlArr[6];
//         $dealArr = getDealsByFilter_CRM_ENTITY(array("ID" => $dealId))[0];
//         $stage_IDArr = explode(":", $dealArr["STAGE_ID"]);
//     }}
...
// $products = getProductsByFilter1($sections["51"]);

// $dealProject = 52;
// $deal = getProductsByFilter1($arFilter);




// if($dealID) {
    //     $dealProds = getDealProds($dealID);
//     if (count($dealProds)) {
    //         $dealProject = $dealProds[0]["IBLOCK_SECTION_ID"];
//     }
// }
...
// $segments = array_values(array_filter(explode('/', $pathname)));
        ...
        <div class="searchbox-container " id="filter">
            ...
            <div class="customfilters" style="display: flex;" id="projectDropdownCatdis_cat">
                ...
                <!-- <div style="display: flex;align-items: center;justify-content: center;margin-right: 10px;">
                    <i id class="fa-solid fa-x" style="cursor: pointer;" onclick="closeFilter('projectDropdownCatdis_cat')"></i>
                </div> -->
            </div>
            ...
            <div class="customfilters" style="display: flex;" id="typeDropdownCatdis_cat">
                ...
                <!-- <div  style="display: flex;align-items: center;justify-content: center;margin-right: 10px;">
                    <i class="fa-solid fa-x" style="cursor: pointer;" onclick="closeFilter('typeDropdownCatdis_cat')"></i>
                </div> -->
            </div>
            ...
            <div class="customfilters" style="display: flex;" id="startPricedis_cat">
                <!-- <div class="search-item rangeCat-block">
                    <div class="price">$</div>
                    <input type="text" id="startPrice" class="rangeCat" placeholder="დან">
                    <input type="text" id="endPrice" class="rangeCat rangeCat--before" placeholder="მდე">
                </div> -->
            ...
            <div class="search-item-plus">
                <div style="display: inline-block; position: relative;">
                    ...
                    <div id="filtersDropdown" class="dropdown-content left-aligned">
                        ...
                        <!-- <a href="#" id="projectDropdownCatdis_cat_x" onclick="showFilter('projectDropdownCatdis_cat')">პროექტი</a> -->
                        <!-- <a href="#" id="typeDropdownCatdis_cat_x" onclick="showFilter('typeDropdownCatdis_cat')">ფართის ტიპი</a> -->
                        <!-- <a href="#" id="statusDropdownCatdis_cat_x" onclick="showFilter('statusDropdownCatdis_cat')">სტატუსი</a> -->
                        ...
                        <!-- <a href="#" id="sideDropdownCatdis_cat_x" onclick="showFilter('sideDropdownCatdis_cat')">ხედი</a> -->
                        <a href="#" id="floorDropdownCatdis_cat_x" onclick="showFilter('floorDropdownCatdis_cat')">სართული</a>
                        <!-- <a href="#" id="brokerDropdownCatdis_cat_x" onclick="showFilter('brokerDropdownCatdis_cat')">ბროკერი</a> -->
                        <!-- <a href="#" id="apartmentNumberdis_cat_x" onclick="showFilter('apartmentNumberdis_cat')">ბინის ნომერი</a> -->
                        ...
                        <!-- <a href="#" id="startSqrdis_cat_x" onclick="showFilter('startSqrdis_cat')">ფართი</a> -->
                        <!-- <a href="#" id="numer_range_x" onclick="showFilter('numer_range')">ბინის ნომერი Range</a> -->
        ...
        <div class="aside-content">
            <div class="apartment-info-block-container" id="apartmentInfoBlockContainer">
                ...
                <!-- <div class="photo-block" id="photoBlock">
                    <img src="" alt="img" style="width: 200px; padding-bottom: 10px; margin-left:-22px;" id="detailImg" class="detail-img" onclick="openModal(this)"> -->
            ...
            <!-- <div id="naxDown" style="padding-bottom: 6px"></div> -->
            ...
            <!-- <div id="newdDropdownBlock"> -->
                      <!-- <div class="new-drop-down-hide-block">
                         <div class="new-drop-down-hide" id="newDropdownCloseBtn" onclick="closeNewDropdown(this)">
                           <a class="new-drop-down-hide__icon">&#8595</a>
                         </div>
                       </div> -->
                <!-- <select name="newDropdown" id="newDropdown"></select> -->
                <!-- <ul id="newDropdown" class="new-drop-down-active">
                    <li></li>
                </ul>
            </div> -->
...
<script>
    ...
    // ყველა ელემენტზე გავდივართ
    // products.forEach(item => {
    //     const floor = item?.[58]; // ვიღებთ სართულის მნიშვნელობას
    //     let block = item?.[73] || "-"; // თუ block არ არსებობს, მნიშვნელობას ვანიჭებთ "A"

    //     if (!grouped[floor]) {
    //         grouped[floor] = {}; // თუ ასეთი სართული ჯერ არ არსებობს, ვქმნით ობიექტს
    //     }

    //     if (!grouped[floor][block]) {
    //         grouped[floor][block] = []; // თუ ასეთი ბლოკი არ არსებობს, ვქმნით მასივს
    //     }

    //     grouped[floor][block].push(item); // ვამატებთ ელემენტს შესაბამის ბლოკში
    // });

// საბოლოო მასივის ფორმირება
// საბოლოო მასივის ფორმირება
// const apartments1 = Object.keys(grouped)
//     .sort((a, b) => {
//         // -1 და -2 სართული უნდა იყოს ბოლო, დანარჩენი სართულები უნდა იწეროს ცხადად
//         if (a === "-1" || a === "-2") return 1;
//         if (b === "-1" || b === "-2") return -1;
//         return a - b; // სართულების დალაგება (რიცხვითი მიმდევრობით)
//     })
//     .map(floor => {
//         // ბლოკების **ანბანურად** დალაგება (A → B → C)
//         const sortedBlocks = Object.keys(grouped[floor])
//             .sort((a, b) => a.localeCompare(b));

//         // ვაბრუნებთ ახალ დალაგებულ ობიექტს
//         return sortedBlocks.reduce((acc, block) => {
//             acc[block] = grouped[floor][block];
//             return acc;
//         }, {});
//     });
...
//     // Inject button and bind globally so onclick can find it
//     window.downloadAllImages = downloadAllImages;
    ...
    // Функция для закрытия дропдауна при клике вне его области
    ...
    // Функция для отображения и скрытия дропдауна с фильтрами
    function toggleDropdown(dropdownId) {
        var dropdown = document.getElementById(dropdownId);
        dropdown.classList.toggle("show");
    }

    // Функция для отображения фильтра по его ID
    // function showFilter(filterId) {

    //     var filter = document.getElementById(filterId);
    //     filter.style.display = "flex";

    //     var link=document.getElementById(filterId+'_x');
    ...
    function showFilter(filterId) {
        ...
        savefilter();
        // moveToEndOfMainDiv(filter);

        dropdown.classList.remove("show");
    }


    // // Функция для закрытия фильтра по крестику
    // function closeFilter(filterId) {
    ...
    //     var link=document.getElementById(filterId+'_x');
    //     link.style.backgroundColor='#fdd4d4';
            ...
            for (var d = 0; d < row.childElementCount; d++) {
                ...
                if (statusi) {
                    ...
                    if(row.children[d].children[0]?.getAttribute("data-square")){
                        // rowData.push(row.children[d].children[0]?.getAttribute("data-square"));
                    ...
                    if(row.children[d].children[0]?.getAttribute("data-price")){
                        // rowData.push(row.children[d].children[0]?.getAttribute("data-price"));
                    ...
                    // if(row.children[d].children[0]?.getAttribute("data-broker")!="undefined"){
                    //     rowData.push(row.children[d].children[0]?.getAttribute("data-broker"));
                    // }else {
                    //     rowData.push(" ");
                    // }
                    ...
                    // if(Number(row.children[d].children[0]?.getAttribute("data-KVMprice-withwhite"))){
                    //     rowData.push(row.children[d].children[0]?.getAttribute("data-KVMprice-withwhite"));
                    // }else {
                    //     rowData.push(" ");
                    // }
                    ...
                    // if(Number(row.children[d].children[0]?.getAttribute("data-price-withwhite"))){
                    //     rowData.push(row.children[d].children[0]?.getAttribute("data-price-withwhite"));
                    // }else {
                    //     rowData.push(" ");
                    // }
    ...
    // console.log(dealId);
    getRetriveData = () => {
        fetch('/rest/local/api/projects/retrieve.php?dealID='+dealId).then(data => {
            return data.json();
        }).then(data => {
            if (data.status === 200) {
                // console.log(data, '1');
                ...
                //dropdown.innerHTML = ''; // Clear previous options if needed
                ...
                // projId = <?echo json_encode($projId);?>;

                // console.log("projId1");   
                // console.log(projId);   


                // projName = <?echo json_encode($projName);?>;
                ...
                // if(dealProject){
                //     document.getElementById('projectDropdownCat').value=dealProject;
           
                // }else{
                //     document.getElementById('projectDropdownCat').value='';
           
                // }
                console.log(dealProject);
                if(dealProject){
                    getData(dealProject);
                }
            } else {
    ...
    function popup(me, i, k, corp) {
        ...
        fetch(`/custom/getstaticfields.php?prodID=${Number(myApartmentID)}`).then(data => {
            ...
            // var sruli_pasebi='<div style="display: flex;">';
            // if (data["PRICE"]) {
            //     sruli_pasebi += '<li class="apartment-about-li" style="font-weight: bold;margin-right: 10px;">სრული ფასი $: <span>' + numberFormat(data["PRICE"]) + '</span></li>';
            // }

            // if (data["KVM_PRICE"]) {
            //     sruli_pasebi += '<li class="apartment-about-li" style="font-weight: bold; margin-left: 16px;">ფასი m<sup>2</sup> $: <span>' + numberFormat(parseInt(data["KVM_PRICE"])) + '</span></li>';
            // }
            // sruli_pasebi+='</div>';
            // dataBlock+=sruli_pasebi;

            // var sruli_kvadratebi='<div style="display: flex;">'

            // if (data["PRICE_GEL"]) {
            //     sruli_kvadratebi += '<li class="apartment-about-li" style="font-weight: bold;margin-right: 10px;">სრული ფასი ₾: <span>' + numberFormat(data["PRICE_GEL"]) + '</span></li>';
            // }

            // if (data["KVM_PRICE_GEL"]) {
            //     sruli_kvadratebi += '<li class="apartment-about-li" style="font-weight: bold;">ფასი m<sup>2</sup> ₾: <span>' + numberFormat(data["KVM_PRICE_GEL"]) + '</span></li>';
    
            // }
            // sruli_kvadratebi+='</div>';
            // dataBlock+=sruli_kvadratebi;

            // dataBlock += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';


            // if (data["FLAT_PRICE"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;border-bottom: 1px solid black;">ბინის ჯამური ღირებულება $: <span>' + Number(data["FLAT_PRICE"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            ...
            // if (data["__4IOFZC"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;">ოთახების რაოდენობა: <span>' + data["__4IOFZC"] + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["Bedrooms"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;">საძინებლების რაოდენობა: <span>' + data["Bedrooms"] + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["__9GBYAF"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> სვ.წერტ რაოდენობა: <span>' + data["__9GBYAF"] + '</span></li>';
            //     dataBlock += '</div>';
            // }



            // if (data["livingarea_price_per"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;">საცხოვრებელი ფართის ფასი 1მ²: <span>' + Number(data["livingarea_price_per"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["livingarea_price_total"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%; border-bottom: 1px solid black;"> საცხოვრებელი ფართის ჯამური ღირებულება: <span>' + Number(data["livingarea_price_total"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["balconyAreaKvmPrice"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> აივნების ფართის ფასი 1მ²: <span>' + Number(data["balconyAreaKvmPrice"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["balconyTotalPrice"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%; border-bottom: 1px solid black;">  აივნების ფართის ჯამური ღირებულება: <span>' + Number(data["balconyTotalPrice"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["terrace_area"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;">  ტერასის ფართი მ²: <span>' + data["terrace_area"] + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["terraceprice_per"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> ტერასის ფართის ფასი 1მ²: <span>' + Number(data["terraceprice_per"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // if (data["terasaPrice"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%; border-bottom: 1px solid black;"> ტერასების ფართის ჯამური ღირებულება: <span>' + Number(data["terasaPrice"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            ...
            // if (data["__PCXGDE"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> ეზოს ფართი მ²: <span>' + data["__PCXGDE"] + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["yardKvmPrice"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> ეზოს ფართის ფასი 1მ²: <span>' + Number(data["yardKvmPrice"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["yardTotalPrice"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;border-bottom: 1px solid black;"> ეზოს ფართის ჯამური ღირებულება: <span>' + Number(data["yardTotalPrice"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }



            // if (data["KVM_PRICE_REPAIR"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> რემონტის ფასი 1მ²: <span>' + Number(data["KVM_PRICE_REPAIR"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["FULL_PRICE_REPAIR"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%; border-bottom: 1px solid black;"> რემონტის ღირებულება: <span>' + Number(data["FULL_PRICE_REPAIR"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }


            // if (data["KVM_PRICE_FURNITURE"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;"> ავეჯის ფასი 1მ²: <span>' + Number(data["KVM_PRICE_FURNITURE"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            // if (data["FULL_PRICE_FURNITURE"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;border-bottom: 1px solid black;"> ავეჯის ღირებულება: <span>' + Number(data["FULL_PRICE_FURNITURE"]).toLocaleString() + '</span></li>';
            //     dataBlock += '</div>';
            // }
            ...
            // if (data["projEndDate"]) {
            //     dataBlock += '<div style="width: 100%; margin-top: 5px;">';
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 100%;">პროექტის დასრულების თარიღი: <span>' + data["projEndDate"] + '</span></li>';
            //     dataBlock += '</div>';
            // }

            // var sruli_kvadratebi = '<div style="display: flex; justify-content: space-between; width: 100%;">';
            // if (data["PRICE_GEL"]) {
            //     sruli_kvadratebi += '<li class="apartment-about-li" style="font-weight: bold; width: 50%;">სრული ფასი ₾: <span>' + numberFormat(data["PRICE_GEL"]) + '</span></li>';
            // }

            // if (data["KVM_PRICE_GEL"]) {
            //     sruli_kvadratebi += '<li class="apartment-about-li" style="font-weight: bold; width: 50%;">ფასი m<sup>2</sup> ₾: <span>' + numberFormat(data["KVM_PRICE_GEL"]) + '</span></li>';
            // }
            // sruli_kvadratebi += '</div>';
            // dataBlock += sruli_kvadratebi;
            ...
            //     // dataBlock += '<li class="apartment-about-li">კონტაქტი: <span> <a href="/crm/contact/details/'+data["CONTACT"]["ID"]+'/">' + data["CONTACT"]["FULL_NAME"] + '</a></span></li>';
        
            //     dataBlock += '<li class="apartment-about-li">კონტაქტი: <span> <a href="/crm/contact/details/'+data["CONTACT"]["ID"]+'/" target="_blank">' + data["CONTACT"]["FULL_NAME"] + '</a></span></li>';

            // }

            // if (data["OWNER_DEAL"]!=='') {
            //     dataBlock += '<li class="apartment-about-li">Deal: <span> <a href="/crm/deal/details/'+data["OWNER_DEAL"]+'/" target="_blank">' + data["OWNER_DEAL"] + '</a></span></li>';
            // }

            // if (data["DEAL_RESPONSIBLE"]!=='') {
            //     dataBlock += '<li class="apartment-about-li"   style="margin-top: -2px;">პასუხისმგებელი: <span> <a href="/company/personal/user/'+data["DEAL_RESPONSIBLE"]+'/" target="_blank">' + data["RESP_NAME"] + '</a></span></li>';
            // }

            // if (data["RESERVED_UNTIL"]) {
            //     dataBlock += '<li class="apartment-about-li" style="font-weight: bold; width: 50%;">დაჯავშნილია თარიღამდე: <span>' +data["RESERVED_UNTIL"] + '</span></li>';
            // }
            ...
            if (data["QUEUE"]!=='') {
                ...
                for (var f = 0; f < javshaniarr.length; f++) {
                    if (javshaniarr[f] !== '') {
                        ...
                        // linksArray.push(`<a href="/crm/deal/details/${javshaniarr[f]}/" target="_blank">${javshaniarr[f]}</a>`);
                        counter++
                    }
                }

                // let linkshtml = linksArray.join(", ");
            ...
            //     addApartmentDetail("SUBMISSION_TYPE", "ჩაბარების ფორმა");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }

            // addApartmentDetail("livingarea_price_per", "საცხოვრებელი ფართის ფასი 1მ²");


            // if(data["livingarea_price_total"]){
            //     addApartmentDetail("livingarea_price_total", "საცხოვრებელი ფართის ჯამური ღირებულება");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }

            // addApartmentDetail("balconyAreaKvmPrice", "აივნების ფართის ფასი 1მ²");



            // if(data["balconyTotalPrice"]){
            //     addApartmentDetail("balconyTotalPrice", "აივნების ფართის ჯამური ღირებულება");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }
            // addApartmentDetail("terrace_area", "ტერასის ფართი მ²");
            // addApartmentDetail("terraceprice_per", "ტერასის ფართის ფასი 1მ²");


            // if(data["terasaPrice"]){
            //     addApartmentDetail("terasaPrice", "ტერასების ფართის ჯამური ღირებულება");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }

            // addApartmentDetail("__PCXGDE", "ეზოს ფართი მ²");
            // addApartmentDetail("yardKvmPrice", "ეზოს ფართის ფასი 1მ²");


            // if(data["yardTotalPrice"]){
            //     addApartmentDetail("yardTotalPrice", "ეზოს ფართის ჯამური ღირებულება");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }
            // addApartmentDetail("KVM_PRICE_REPAIR", "რემონტის ფასი 1მ²");

            // if(data["FULL_PRICE_REPAIR"]){
            //     addApartmentDetail("FULL_PRICE_REPAIR", "რემონტის ღირებულება");
            //     newdrop.innerHTML += '<li class="apartment-about-li" style="font-weight: bold;border-bottom: 1px solid black"><span></span></li>';

            // }

            // addApartmentDetail("KVM_PRICE_FURNITURE", "ავეჯის ფასი 1მ²");
            // addApartmentDetail("FULL_PRICE_FURNITURE", "ავეჯის ღირებულება");
    ...
    checkStatusInfo = () => {
        ...
        apartmaentStatus.forEach(element => {
            ...
            // pathname1 = window.location.pathname.split("/");
            // if (dealId >20) {
            //     document.getElementById('addBtn').style.display="none";
            //     document.getElementById('delBtn').style.display="none";
    ...
    //     me.nextElementSibling.children[0].children[1].src = me.src;
    ...
    for (let i = 0; i < resProperties.length; i++) {
        ...
        var range_filters = [
            'ბინის №' ,'ოთახების რაოდენობა', 'სართული', 'ნიშნული', 'ბლოკი', 'სადარბაზო', 'საერთო ფართი', 
            'ფართი (საცხოვრებელი)', 'საზაფხულო ფართი', 'აივნების ჯამური ფართი', 'საძინებლის ფართი 1', 'საძინებლის ფართი 2', 
            'საძინებლის ფართი 3', 'საძინებლის ფართი 4', 'საძინებლის ფართი 5', 'საძინებლების ჯამური ფართი', 'სვ.წერტ.ფართი 1', 
            'სვ.წერტ.ფართი 2', 'სვ.წერტ.ფართი 3', 'საზაფხულო ფართი', 'ტერასასის ფართი 1', 'აივნის ფართი 1', 'აივნის ფართი 2', 
            'აივნის ფართი 3', 'აივნის ფართი 4', 'აივნის ფართი 5', 'სვ.წერტ.რაოდენობა', 'მთლიანი სვ.წერტ.კვ.მ', 'საგარდერობე', 
            'მისაღები და სამზარეულოს ჯამური ფართი', 'სამზარეულოს ფართი', 'ჰოლის ჯამური ფართი', 'ოთახების რაოდენობა', 
            'საერთო ფართი', 'მისაღების ფართი 1', 'აივნების ჯამური ფართი', 'ეფექტური ფართი', 'ჰოლის ფართი 1', 
            'ჰოლის ფართი 2', 'ჰოლის ფართი 3', 'სადარბაზო', 'სამრეცხაო 1', 'სამრეცხაო 2', 'სამრეცხაოს ჯამი', 
            'ჭერის სიმაღლე 1', 'ჭერის სიმაღლე 2', 'ტერასასის ფართი 2', 'ტერასასის ფართი 3', 'ტერასასების ჯამური ფართი', 
            'მისაღების ფართი 2', 'მისაღებების ჯამური ფართი','ფასი აივანი m2','ფასი ტერასა m2','მთლიანი  სვ.წერტ.m2'
        ];
