...
if ($dealID) {
    ...
    if ($prod_ID) {
        ...
        $chabarebatype = $productInfo[0]["SUBMISSION_TYPE"];
...
$gegmaFilter = array(
    "IBLOCK_ID" => 29,
    "PROPERTY_product_type" => getWorkflowFieldsKeyByValue("194", $productInfo[0]["PRODUCT_TYPE"]),
    "PROPERTY_section" => $productInfo[0]["IBLOCK_SECTION_ID"],
    "PROPERTY_floor" => getWorkflowFieldsKeyByValue("195", $productInfo[0]["FLOOR"]),
    "PROPERTY_ACTIVE" => 179,
);
...
<div class="main-container">
    ...
    <!-- Export Buttons -->
    <div class="export-buttons element-to-hide"  style="display: none;">
    ...
    <div class="form-row">
        <div class="form-field">
            ...
            <input type="text" id="chabarebatype" class="form-control" disabled>
        </div>

        <div class="form-field element-to-hide">
            <label>მოლაპარაკება №</label>
            <div id="DEALID" class="form-control" style="font-weight: bold;"></div>
        </div>
    ...
    <div class="form-row">
        <div class="form-field hidden">
            ...
            <select id="ganvadebaType" class="form-select green-border" onchange="changeType();">
                <option value="mortgage">სტანდარტული განვადება</option>
                <option value="customType" selected>არასტანდარტული განვადება</option>
...
async function saveGraphCalculation() {
    ...
    if(!ipotekaDiv.classList.contains("hidden")){
...
function changeLanguage(lang) {
    if (document.getElementById('graph_date')) {
        document.getElementById('graph_date').textContent = translations[lang].graph_date;
        document.getElementById('graph_amount').textContent = translations[lang].graph_amount;
        document.getElementById('graph_left').textContent = translations[lang].graph_left;
    }
    if (document.getElementById("lastPaymentGraph")) {
        document.getElementById("lastPaymentGraph").textContent = translations[lang].lastPayment;
    }
    if (document.getElementById("firstPayment")) {
        document.getElementById("firstPayment").textContent = translations[lang].firstPayment;
    }
}
